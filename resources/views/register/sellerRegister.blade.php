    ...
    <div class="login-wrap">
        <div class="login-html">
            ...
            <div class="login-form">
                ...
                <form action="{{ route('SellerRegister') }}" method="POST" class="sign-up-htm">
                    @csrf
                    <div class="group">
                    ...
                    <div class="group">
                        <input type="submit" class="button" value="Sign Up as Seller">
                    </div>
                    <div class="foot-lnk">
                        <label ><a href="{{route('Buyerregister')}}">Sign up as a buyer</a></label>
                    </div>
